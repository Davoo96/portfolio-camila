const Skills = ({ skills }: { skills: { skill: string; icon: string } }) => {
  return (
    <div className="mx-auto mb-8 grid max-w-[296px] grid-cols-8 items-center justify-between rounded-[100px] border-2 border-white px-3 py-7 md:max-w-[640px] md:grid-cols-8">
